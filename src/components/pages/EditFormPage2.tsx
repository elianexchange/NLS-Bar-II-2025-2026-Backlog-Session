...
export function EditFormPage2() {
  const [formData, setFormData] = useState({
    ...
    surname: " AFAM ",
    otherNames: "DAVID ORANYELI",
    dateOfBirth: "27/05/2002",
    email: "davidoranyeli11@gmail.com",
    nationality: "Nigerian",
    gender: "MALE",
    stateAndLocalGovt: "Oshimili South / Delta State",
    firstCampusOfChoice: "Abuja",
    secondCampusOfChoice: "Port Harcourt",
    degreeObtained: "LL.B",
    maritalStatus: "Single",
    title: "MR.",
    homeAddressInNigeria: "AMAC HOUSING ESTATE LUGBE ABUJA",
    telephoneNumber: "09069789316",
    stateOfOrigin: "Oshimili South / Delta State",
    nameOfNextOfKin: "DR. EBIYE SAWYER",
    addressOfNextOfKin: "AMAC HOUSING ESTATE LUGBE ABUJA",
    nextOfKinRelationship: "FATHER",
    phoneNumberOfNextOfKin: "07059505914",
    classOfDegreeObtained: "Second_Class_Upper",
    addressOfInstitutionAttended: "Off Upper Adebayo Road, GRA, Benin City 300102, Edo",
    nameOfInstitutionAttended2: "Benson Idahosa University",
    degreeObtained2: "LL.B",
    period2: "",
    ...
    degreeObtained4: "",
    period4: "",
    headOfLawFaculty: "DR. THEOPHILUS NWANO",
