            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="bg-gray-100 p-2 rounded">LAW/170174</div>
                </div>
                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  <div>
                    ...
                    <div className="bg-gray-100 p-2 rounded text-sm">EBIYE</div>
                  </div>
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Othernames</label>
                    <div className="bg-gray-100 p-2 rounded text-sm">GODSWILL INEIBOLUOFINI</div>
                  </div>
                  <div>
