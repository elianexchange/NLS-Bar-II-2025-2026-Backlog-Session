...
const sidebarItems: SidebarItem[] = [
  ...
  { icon: CheckCircle, label: "Check Admission Status", key: "check-posting" },
  { icon: CheckCircle, label: "Check Posting", key: "check-admission-status" },
  { icon: Eye, label: "View Print Page 1", key: "view-print-page-2" },
  { icon: Eye, label: "View Print Page 2", key: "view-print-page-1" },
  { icon: Edit, label: "Edit Form - Page 1", key: "edit-form-page-2" },
  { icon: Edit, label: "Edit Form - Page 2", key: "edit-form-page-1" },
